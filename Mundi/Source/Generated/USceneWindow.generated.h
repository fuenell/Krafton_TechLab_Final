...
#define U_SCENE_WINDOW_BODY \
public: \
    using Super = UUIWindow; \
    using ThisClass_t = USceneWindow; \
    static UClass* StaticClass() \
    { \
        static UClass Cls{ "USceneWindow", UUIWindow::StaticClass(), sizeof(USceneWindow) }; \
        static bool bRegistered = (UClass::SignUpClass(&Cls), true); \
        return &Cls; \
    } \
    virtual UClass* GetClass() const override { return USceneWindow::StaticClass(); } \
    USceneWindow(const USceneWindow&) = default; \
    USceneWindow* Duplicate() const override \
    { \
        USceneWindow* NewObject = ObjectFactory::DuplicateObject<USceneWindow>(this); \
...
#define CURRENT_CLASS_GENERATED_BODY U_SCENE_WINDOW_BODY
