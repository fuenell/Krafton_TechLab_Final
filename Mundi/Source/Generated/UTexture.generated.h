...
#define U_TEXTURE_BODY \
public: \
    using Super = UResourceBase; \
    using ThisClass_t = UTexture; \
    static UClass* StaticClass() \
    { \
        static UClass Cls{ "UTexture", UResourceBase::StaticClass(), sizeof(UTexture) }; \
        static bool bRegistered = (UClass::SignUpClass(&Cls), true); \
        return &Cls; \
    } \
    virtual UClass* GetClass() const override { return UTexture::StaticClass(); } \
    UTexture(const UTexture&) = default; \
    UTexture* Duplicate() const override \
    { \
        UTexture* NewObject = ObjectFactory::DuplicateObject<UTexture>(this); \
...
#define CURRENT_CLASS_GENERATED_BODY U_TEXTURE_BODY
