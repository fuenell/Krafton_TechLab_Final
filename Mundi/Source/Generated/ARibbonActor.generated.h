...
#define A_RIBBON_ACTOR_BODY \
public: \
    using Super = AActor; \
    using ThisClass_t = ARibbonActor; \
    static UClass* StaticClass() \
    { \
        static UClass Cls{ "ARibbonActor", AActor::StaticClass(), sizeof(ARibbonActor) }; \
        static bool bRegistered = (UClass::SignUpClass(&Cls), true); \
        return &Cls; \
    } \
    virtual UClass* GetClass() const override { return ARibbonActor::StaticClass(); } \
    ARibbonActor(const ARibbonActor&) = default; \
    ARibbonActor* Duplicate() const override \
    { \
        ARibbonActor* NewObject = ObjectFactory::DuplicateObject<ARibbonActor>(this); \
...
#define CURRENT_CLASS_GENERATED_BODY A_RIBBON_ACTOR_BODY
