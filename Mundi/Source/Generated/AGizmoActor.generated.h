...
#define A_GIZMO_ACTOR_BODY \
public: \
    using Super = AActor; \
    using ThisClass_t = AGizmoActor; \
    static UClass* StaticClass() \
    { \
        static UClass Cls{ "AGizmoActor", AActor::StaticClass(), sizeof(AGizmoActor) }; \
        static bool bRegistered = (UClass::SignUpClass(&Cls), true); \
        return &Cls; \
    } \
    virtual UClass* GetClass() const override { return AGizmoActor::StaticClass(); } \
    AGizmoActor(const AGizmoActor&) = default; \
    AGizmoActor* Duplicate() const override \
    { \
        AGizmoActor* NewObject = ObjectFactory::DuplicateObject<AGizmoActor>(this); \
...
#define CURRENT_CLASS_GENERATED_BODY A_GIZMO_ACTOR_BODY
