...
#define U_IM_GUI_HELPER_BODY \
public: \
    using Super = UObject; \
    using ThisClass_t = UImGuiHelper; \
    static UClass* StaticClass() \
    { \
        static UClass Cls{ "UImGuiHelper", UObject::StaticClass(), sizeof(UImGuiHelper) }; \
        static bool bRegistered = (UClass::SignUpClass(&Cls), true); \
        return &Cls; \
    } \
    virtual UClass* GetClass() const override { return UImGuiHelper::StaticClass(); } \
    UImGuiHelper(const UImGuiHelper&) = default; \
    UImGuiHelper* Duplicate() const override \
    { \
        UImGuiHelper* NewObject = ObjectFactory::DuplicateObject<UImGuiHelper>(this); \
...
#define CURRENT_CLASS_GENERATED_BODY U_IM_GUI_HELPER_BODY
