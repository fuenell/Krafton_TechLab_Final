...
#define U_DYNAMIC_MESH_BODY \
public: \
    using Super = UResourceBase; \
    using ThisClass_t = UDynamicMesh; \
    static UClass* StaticClass() \
    { \
        static UClass Cls{ "UDynamicMesh", UResourceBase::StaticClass(), sizeof(UDynamicMesh) }; \
        static bool bRegistered = (UClass::SignUpClass(&Cls), true); \
        return &Cls; \
    } \
    virtual UClass* GetClass() const override { return UDynamicMesh::StaticClass(); } \
    UDynamicMesh(const UDynamicMesh&) = default; \
    UDynamicMesh* Duplicate() const override \
    { \
        UDynamicMesh* NewObject = ObjectFactory::DuplicateObject<UDynamicMesh>(this); \
...
#define CURRENT_CLASS_GENERATED_BODY U_DYNAMIC_MESH_BODY
