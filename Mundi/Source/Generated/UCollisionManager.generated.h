...
#define U_COLLISION_MANAGER_BODY \
public: \
    using Super = UObject; \
    using ThisClass_t = UCollisionManager; \
    static UClass* StaticClass() \
    { \
        static UClass Cls{ "UCollisionManager", UObject::StaticClass(), sizeof(UCollisionManager) }; \
        static bool bRegistered = (UClass::SignUpClass(&Cls), true); \
        return &Cls; \
    } \
    virtual UClass* GetClass() const override { return UCollisionManager::StaticClass(); } \
    UCollisionManager(const UCollisionManager&) = default; \
    UCollisionManager* Duplicate() const override \
    { \
        UCollisionManager* NewObject = ObjectFactory::DuplicateObject<UCollisionManager>(this); \
...
#define CURRENT_CLASS_GENERATED_BODY U_COLLISION_MANAGER_BODY
