...
#define U_RENDER_MANAGER_BODY \
public: \
    using Super = UObject; \
    using ThisClass_t = URenderManager; \
    static UClass* StaticClass() \
    { \
        static UClass Cls{ "URenderManager", UObject::StaticClass(), sizeof(URenderManager) }; \
        static bool bRegistered = (UClass::SignUpClass(&Cls), true); \
        return &Cls; \
    } \
    virtual UClass* GetClass() const override { return URenderManager::StaticClass(); } \
    URenderManager(const URenderManager&) = default; \
    URenderManager* Duplicate() const override \
    { \
        URenderManager* NewObject = ObjectFactory::DuplicateObject<URenderManager>(this); \
...
#define CURRENT_CLASS_GENERATED_BODY U_RENDER_MANAGER_BODY
