...
BEGIN_PROPERTIES(USkeletalMeshComponent)
    ...
    ADD_PROPERTY(UAnimInstance*, AnimInstance, "Animation", true)
END_PROPERTIES()
...
{
    AddPropertyPtr<USkeletalMeshComponent, UAnimInstance>(
        T, "AnimInstance", &USkeletalMeshComponent::AnimInstance);
