...
BEGIN_PROPERTIES(AActor)
    ...
    ADD_PROPERTY(UWorld*, World, "Actor", true)
    ADD_PROPERTY(USceneComponent*, RootComponent, "Actor", true)
    ADD_PROPERTY(UTextRenderComponent*, TextComp, "Actor", true)
...
LUA_BIND_BEGIN(AActor)
{
    ...
    AddPropertyPtr<AActor, UWorld>(
        T, "World", &AActor::World);
    AddPropertyPtr<AActor, USceneComponent>(
        T, "RootComponent", &AActor::RootComponent);
    AddPropertyPtr<AActor, UTextRenderComponent>(
        T, "TextComp", &AActor::TextComp);
