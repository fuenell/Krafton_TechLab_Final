...
#define U_LINE_COMPONENT_BODY \
public: \
    using Super = UPrimitiveComponent; \
    using ThisClass_t = ULineComponent; \
    static UClass* StaticClass() \
    { \
        static UClass Cls{ "ULineComponent", UPrimitiveComponent::StaticClass(), sizeof(ULineComponent) }; \
        static bool bRegistered = (UClass::SignUpClass(&Cls), true); \
        return &Cls; \
    } \
    virtual UClass* GetClass() const override { return ULineComponent::StaticClass(); } \
    ULineComponent(const ULineComponent&) = default; \
    ULineComponent* Duplicate() const override \
    { \
        ULineComponent* NewObject = ObjectFactory::DuplicateObject<ULineComponent>(this); \
...
#define CURRENT_CLASS_GENERATED_BODY U_LINE_COMPONENT_BODY
