...
#define U_CONSOLE_WIDGET_BODY \
public: \
    using Super = UWidget; \
    using ThisClass_t = UConsoleWidget; \
    static UClass* StaticClass() \
    { \
        static UClass Cls{ "UConsoleWidget", UWidget::StaticClass(), sizeof(UConsoleWidget) }; \
        static bool bRegistered = (UClass::SignUpClass(&Cls), true); \
        return &Cls; \
    } \
    virtual UClass* GetClass() const override { return UConsoleWidget::StaticClass(); } \
    UConsoleWidget(const UConsoleWidget&) = default; \
    UConsoleWidget* Duplicate() const override \
    { \
        UConsoleWidget* NewObject = ObjectFactory::DuplicateObject<UConsoleWidget>(this); \
...
#define CURRENT_CLASS_GENERATED_BODY U_CONSOLE_WIDGET_BODY
