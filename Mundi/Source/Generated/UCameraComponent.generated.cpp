...
BEGIN_PROPERTIES(UCameraComponent)
    ...
    ADD_PROPERTY(class UStaticMeshComponent*, CameraGizmo, "Camera", true)
END_PROPERTIES()
...
LUA_BIND_BEGIN(UCameraComponent)
{
    ...
    AddPropertyPtr<UCameraComponent, class UStaticMeshComponent>(
        T, "CameraGizmo", &UCameraComponent::CameraGizmo);
}
LUA_BIND_END()
