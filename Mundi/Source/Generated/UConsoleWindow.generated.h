...
#define U_CONSOLE_WINDOW_BODY \
public: \
    using Super = UUIWindow; \
    using ThisClass_t = UConsoleWindow; \
    static UClass* StaticClass() \
    { \
        static UClass Cls{ "UConsoleWindow", UUIWindow::StaticClass(), sizeof(UConsoleWindow) }; \
        static bool bRegistered = (UClass::SignUpClass(&Cls), true); \
        return &Cls; \
    } \
    virtual UClass* GetClass() const override { return UConsoleWindow::StaticClass(); } \
    UConsoleWindow(const UConsoleWindow&) = default; \
    UConsoleWindow* Duplicate() const override \
    { \
        UConsoleWindow* NewObject = ObjectFactory::DuplicateObject<UConsoleWindow>(this); \
...
#define CURRENT_CLASS_GENERATED_BODY U_CONSOLE_WINDOW_BODY
