...
public: \
    using Super = UObject; \
    using ThisClass_t = ULevel; \
    static UClass* StaticClass() \
    { \
        static UClass Cls{ "ULevel", UObject::StaticClass(), sizeof(ULevel) }; \
        static bool bRegistered = (UClass::SignUpClass(&Cls), true); \
        return &Cls; \
    } \
    virtual UClass* GetClass() const override { return ULevel::StaticClass(); } \
    ULevel(const ULevel&) = default; \
    ULevel* Duplicate() const override \
    { \
        ULevel* NewObject = ObjectFactory::DuplicateObject<ULevel>(this); \
...
#define CURRENT_CLASS_GENERATED_BODY U_LEVEL_BODY
