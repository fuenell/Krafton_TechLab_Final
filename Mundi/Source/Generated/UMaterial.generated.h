...
#define U_MATERIAL_BODY \
public: \
    using Super = UMaterialInterface; \
    using ThisClass_t = UMaterial; \
    static UClass* StaticClass() \
    { \
        static UClass Cls{ "UMaterial", UMaterialInterface::StaticClass(), sizeof(UMaterial) }; \
        static bool bRegistered = (UClass::SignUpClass(&Cls), true); \
        return &Cls; \
    } \
    virtual UClass* GetClass() const override { return UMaterial::StaticClass(); } \
    UMaterial(const UMaterial&) = default; \
    UMaterial* Duplicate() const override \
    { \
        UMaterial* NewObject = ObjectFactory::DuplicateObject<UMaterial>(this); \
...
#define CURRENT_CLASS_GENERATED_BODY U_MATERIAL_BODY
