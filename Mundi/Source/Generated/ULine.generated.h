...
public: \
    using Super = UObject; \
    using ThisClass_t = ULine; \
    static UClass* StaticClass() \
    { \
        static UClass Cls{ "ULine", UObject::StaticClass(), sizeof(ULine) }; \
        static bool bRegistered = (UClass::SignUpClass(&Cls), true); \
        return &Cls; \
    } \
    virtual UClass* GetClass() const override { return ULine::StaticClass(); } \
    ULine(const ULine&) = default; \
    ULine* Duplicate() const override \
    { \
        ULine* NewObject = ObjectFactory::DuplicateObject<ULine>(this); \
...
#define CURRENT_CLASS_GENERATED_BODY U_LINE_BODY
