...
BEGIN_PROPERTIES(ADirectionalLightActor)
    ...
    ADD_PROPERTY(UDirectionalLightComponent*, LightComponent, "Components", true)
END_PROPERTIES()
...
{
    AddPropertyPtr<ADirectionalLightActor, UDirectionalLightComponent>(
        T, "LightComponent", &ADirectionalLightActor::LightComponent);
}
LUA_BIND_END()
